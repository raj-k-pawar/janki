...
class BookingModel {
  ...
  BookingModel({
    ...
    String? bookingDate,
    this.createdAt,
  }) : bookingDate = bookingDate ?? _todayStr();
  ...
  factory BookingModel.fromJson(Map<String, dynamic> json) {
    return BookingModel(
      ...
      batchType: json['batch_type']?.toString() ?? 'full_day',
      ...
      bookingDate: json['booking_date']?.toString() ?? _todayStr(),
  ...
  String get batchLabel {
    if (batchType == 'full_day') return 'Full Day (10AM-6PM)';
    if (batchType == 'morning') return 'Morning (10AM-3PM)';
    if (batchType == 'afternoon') return 'Afternoon (3PM-8PM)';
    return batchType;
  }
...
class WorkerModel {
  ...
  WorkerModel({
    ...
    String? joiningDate,
    this.status = 'active',
  }) : joiningDate = joiningDate ?? _todayStr();
