...
class _ManagerDashboardState extends State<ManagerDashboard> {
  ...
  void initState() {
    ...
    _todayDate = '${now.year}-$m-$d';
    _loadStats();
  }

  Future<void> _loadStats() async {
    setState(() => _loading = true);
    final result = await ApiService().getDashboardStats(_todayDate);
    if (mounted) {
      setState(() {
            ...
            children: [
              ...
              GridView.count(
                ...
                children: [
                  ...
                  _StatCard(
                    label: 'Total Revenue',
                    value: _currency(_stats['total_revenue']),
                  ...
                  _StatCard(
                    label: 'Cash Payment',
                    value: _currency(_stats['cash_payment']),
                    icon: Icons.money,
                  ...
                  _StatCard(
                    ...
                    value: _currency(_stats['online_payment']),
