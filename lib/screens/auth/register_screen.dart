...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  @override
  void dispose() {
    _nameCtrl.dispose(); _userCtrl.dispose(); _passCtrl.dispose();
    _cpassCtrl.dispose(); _phoneCtrl.dispose();
    super.dispose();
  }
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Join Janki Agro Tourism',
                              style: GoogleFonts.poppins(
                                  fontSize: 18, fontWeight: FontWeight.w700,
                                  color: AppColors.textDark)),
                          Text('Fill in details to create your account',
                              style: GoogleFonts.poppins(
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: IconButton(
                                icon: Icon(
                                  _cobscure ? Icons.visibility_off_outlined
                                      : Icons.visibility_outlined,
                                  color: AppColors.textLight, size: 20,
                                ),
                                onPressed: () =>
